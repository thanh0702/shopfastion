...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('employee.suppliers.index') }}">Suppliers</a></li>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="bi bi-plus-circle"></i> Thêm nhà cung cấp</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('employee.suppliers.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Thêm nhà cung cấp
                        </button>
                    </div>
                </form>
            </div>
