...
<a href="{{ route('employee.products.create') }}" class="btn btn-primary mb-3">Thêm sản phẩm mới</a>
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('employee.products.edit', $product) }}" class="btn btn-sm btn-warning" title="Edit">
                    <i class="bi bi-pencil-square"></i>
                </a>
                <form action="{{ route('employee.products.delete', $product) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this product?');">
                    @csrf
                    @method('DELETE')
